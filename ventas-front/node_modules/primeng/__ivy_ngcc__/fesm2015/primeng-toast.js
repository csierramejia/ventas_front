...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r615); const ctx_r614 = ɵngcc0.ɵɵnextContext(); return ctx_r614.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r615); const ctx_r616 = ɵngcc0.ɵɵnextContext(); return ctx_r616.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r612.message.severity == "info", ctx_r612.message.severity == "warn", ctx_r612.message.severity == "error", ctx_r612.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r612.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r612.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r622); const ctx_r621 = ɵngcc0.ɵɵnextContext(); return ctx_r621.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r622); const ctx_r623 = ɵngcc0.ɵɵnextContext(); return ctx_r623.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r619 = ctx.$implicit;
    const i_r620 = ctx.index;
    const ctx_r618 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r619)("index", i_r620)("template", ctx_r618.template)("@toastAnimation", undefined)("showTransitionOptions", ctx_r618.showTransitionOptions)("hideTransitionOptions", ctx_r618.hideTransitionOptions);
} }
