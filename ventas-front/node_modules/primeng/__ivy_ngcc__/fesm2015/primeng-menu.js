...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r505.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r507); const ctx_r506 = ɵngcc0.ɵɵnextContext(); return ctx_r506.menu.itemClick($event, ctx_r506.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r503.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r503.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r503.item.tabindex ? ctx_r503.item.tabindex : "0")("data-automationid", ctx_r503.item.automationId)("target", ctx_r503.item.target)("title", ctx_r503.item.title)("id", ctx_r503.item.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r503.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r503.item.label);
} }
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 5);
} if (rf & 2) {
    const ctx_r508 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r508.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r510); const ctx_r509 = ɵngcc0.ɵɵnextContext(); return ctx_r509.menu.itemClick($event, ctx_r509.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r504.item.routerLink)("queryParams", ctx_r504.item.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", ctx_r504.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(12, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(13, _c1, ctx_r504.item.disabled));
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r504.item.automationId)("target", ctx_r504.item.target)("id", ctx_r504.item.id)("tabindex", ctx_r504.item.tabindex ? ctx_r504.item.tabindex : "0")("title", ctx_r504.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r504.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r504.item.label);
} }
const _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r516 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r516.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r516 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r516.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r516.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r516.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    const item_r522 = ɵngcc0.ɵɵnextContext().$implicit;
    const submenu_r516 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r522.visible === false || submenu_r516.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r522 = ɵngcc0.ɵɵnextContext().$implicit;
    const submenu_r516 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r522.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r522)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r522.visible === false || submenu_r516.visible === false))("ngStyle", item_r522.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r522 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r522.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r522.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r516 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r516.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r516.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r516.items);
} }
function Menu_div_0_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r513.model);
} }
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    const item_r530 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r530.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r530)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r530.visible === false))("ngStyle", item_r530.style);
} }
...
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r514.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r536); const ctx_r535 = ɵngcc0.ɵɵnextContext(); return ctx_r535.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r536); const ctx_r537 = ɵngcc0.ɵɵnextContext(); return ctx_r537.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵclassMap(ctx_r511.styleClass);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r511.popup))("ngStyle", ctx_r511.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r511.showTransitionOptions, ctx_r511.hideTransitionOptions)))("@.disabled", ctx_r511.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r511.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r511.hasSubMenu());
} }
