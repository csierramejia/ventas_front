...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r490 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r490.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r492); const ctx_r491 = ɵngcc0.ɵɵnextContext(); return ctx_r491.menu.itemClick($event, ctx_r491.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r488.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r488.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r488.item.tabindex ? ctx_r488.item.tabindex : "0")("data-automationid", ctx_r488.item.automationId)("target", ctx_r488.item.target)("title", ctx_r488.item.title)("id", ctx_r488.item.id);
    ɵngcc0.ɵɵadvance(1);
...
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r493 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r493.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r495); const ctx_r494 = ɵngcc0.ɵɵnextContext(); return ctx_r494.menu.itemClick($event, ctx_r494.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r489.item.routerLink)("queryParams", ctx_r489.item.queryParams)("routerLinkActive", "ui-state-active")("routerLinkActiveOptions", ctx_r489.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(12, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(13, _c1, ctx_r489.item.disabled));
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r489.item.automationId)("target", ctx_r489.item.target)("id", ctx_r489.item.id)("tabindex", ctx_r489.item.tabindex ? ctx_r489.item.tabindex : "0")("title", ctx_r489.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r489.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r489.item.label);
} }
const _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r501 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r501.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r501 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r501.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r501.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r501.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 7);
} if (rf & 2) {
    const item_r507 = ɵngcc0.ɵɵnextContext().$implicit;
    const submenu_r501 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r507.visible === false || submenu_r501.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r507 = ɵngcc0.ɵɵnextContext().$implicit;
    const submenu_r501 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r507.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r507)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r507.visible === false || submenu_r501.visible === false))("ngStyle", item_r507.style);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r507 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r507.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r507.separator);
} }
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const submenu_r501 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r501.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r501.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r501.items);
} }
...
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r515 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r515.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    const item_r515 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r515.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r515)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r515.visible === false))("ngStyle", item_r515.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r515 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", item_r515.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r515.separator);
} }
function Menu_div_0_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r499.model);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r521); const ctx_r520 = ɵngcc0.ɵɵnextContext(); return ctx_r520.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r521); const ctx_r522 = ɵngcc0.ɵɵnextContext(); return ctx_r522.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r496.popup))("ngStyle", ctx_r496.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r496.showTransitionOptions, ctx_r496.hideTransitionOptions)))("@.disabled", ctx_r496.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r496.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r496.hasSubMenu());
} }
